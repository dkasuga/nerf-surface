import argparse
# from training.idr_train import NeuSTrainRunner
from idr_train import NeuSTrainRunner
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpu', type=int, default=0, help='GPU to use [default: GPU auto]')
    ...
    trainrunner = NeuSTrainRunner(conf=opt.conf,
